    ...
    from-[#6A1B9A] to-[#8E24AA] text-white  font-bold tracking-wider rounded-lg ">
      <div className="mx-auto w-full max-w-7xl px-8 text-white">
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="white"
                  className=" mb-3 font-medium opacity-40 text-white  tracking-wide"
                >
                  {title}
                </Typography>
                {items.map((link) => (
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center  font-normaltext-white font-bold tracking-wider md:mb-0"
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Material Tailwind</a>. All
            Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-white font-bold tracking-wider sm:justify-center">
